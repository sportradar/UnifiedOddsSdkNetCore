...
{
    protected readonly Urn DefaultCompetitorId = Urn.Parse("sr:competitor:123");
    protected const string DefaultCompetitorName = "some-default-competitor-name";
    public readonly Urn DefaultPlayerId = Urn.Parse("sr:player:589");
    public const string DefaultPlayerName = "some-default-player-name";
    protected const string DefaultDivisionName = "some-default-division-name";

    public team GetApiTeamFull(int competitorId = 123, int playerSize = 15)
    {
    ...
    public teamExtended GetApiTeamExtendedFull(int competitorId = 123, int playerSize = 15)
    {
        var resultCompetitorId = competitorId == 0 ? Random.Shared.Next(1, 10_000) : competitorId;
    ...
    public competitorProfileEndpoint GetApiCompetitorProfileFull(int competitorId = 123, int playerSize = 15)
    {
        var resultCompetitorId = competitorId == 0 ? Random.Shared.Next(1, 10_000) : competitorId;
        return new competitorProfileEndpoint
        {
            competitor = GetApiTeamExtendedFull(resultCompetitorId),
    ...
    public simpleTeamProfileEndpoint GetApiSimpleTeamProfileFull(int competitorId = 123, int playerSize = 15)
    {
        var resultCompetitorId = competitorId == 0 ? Random.Shared.Next(1, 10_000) : competitorId;
    ...
    public raceTeam GetApiRaceTeamFull(int competitorId = 123, int playerSize = 15)
    {
        var resultCompetitorId = competitorId == 0 ? Random.Shared.Next(1, 10_000) : competitorId;
        return new raceTeam
        {
    ...
    public teamCompetitor GetApiTeamCompetitorFull(int competitorId = 123, int playerSize = 15)
    {
        var resultCompetitorId = competitorId == 0 ? Random.Shared.Next(1, 10_000) : competitorId;
    ...
    public playerExtended GetApiPlayerExtended(int playerId = 1)
    {
    ...
    public playerExtended[] GetApiPlayersExtended(int playerSize = 15)
    {
    ...
    public playerCompetitor[] GetApiPlayerCompetitors(int playerSize = 15)
    {
    ...
    public playerCompetitor GetApiPlayerCompetitor(int playerId = 0)
    {
    ...
    public competitorReferenceIdsReference_id[] GetApiCompetitorReference(int betradarId, int rotationNumber)
    {
    ...
    internal raceDriverProfile GetApiRaceDriverProfile(int competitorId = 123)
    {
        var resultCompetitorId = competitorId == 0 ? Random.Shared.Next(1, 10_000) : competitorId;
    ...
    internal raceDriver GetApiRaceDriver(int competitorId = 123)
    {
    ...
    internal jersey GetApiJersey(int jerseyNumber = 1)
    {
        return new jersey
        {
    ...
    internal jersey[] GetApiJerseys(int size)
    {
    ...
    internal void ValidatePlayerCompetitor(playerCompetitor apiPlayerCompetitor, PlayerCompetitorDto playerCompetitorDto)
    {
    ...
    internal void ValidateTeamWithCompetitor(team apiTeam, CompetitorDto dto)
    {
    ...
    internal CompetitorDto GetCompetitorWithDivision(int divisionId = 1010)
    {
    ...
    internal CompetitorDto GetCompetitorWithoutDivision()
    {
    ...
    internal CompetitorProfileDto GetCompetitorProfileWithDivision(int divisionId = 1010)
    {
    ...
    internal CompetitorProfileDto GetCompetitorProfileWithoutDivision()
    {
        var apiCompetitorProfile = GetApiCompetitorProfileFull(1, 0);
    ...
    internal SimpleTeamProfileDto GetSimpleTeamProfileWithDivision(int divisionId = 1010)
    {
    ...
    internal SimpleTeamProfileDto GetSimpleTeamProfileWithoutDivision()
    {
        var apiSimpleTeamProfile = GetApiSimpleTeamProfileFull(1, 0);
    ...
    internal TeamCompetitorDto GetTeamCompetitorWithDivision(int divisionId = 1010)
    {
    ...
    internal TeamCompetitorDto GetTeamCompetitorWithoutDivision()
    {
        var apiTeamCompetitor = GetApiTeamCompetitorFull(1, 0);
    ...
    internal void ValidateCompetitorDtoWithCi(CompetitorDto dto, CompetitorCacheItem ci, CultureInfo culture)
    {
