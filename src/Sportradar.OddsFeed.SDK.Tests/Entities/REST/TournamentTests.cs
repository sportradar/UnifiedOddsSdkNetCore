...
public class TournamentTests
{
    ...
    private TournamentInfoCacheItem _tourCiData;
    private tournamentInfoEndpoint _seasonApiData;
    private TournamentInfoDto _seasonDtoData;
    private TournamentInfoCacheItem _seasonCiData;
    ...
    private static void VerifyTournamentGroups(IEnumerable<tournamentGroup> apiGroups, IEnumerable<GroupCacheItem> ciTourGroups)
    {
