...
public class LogHttpDataFetcherWireMockTests : IAsyncLifetime
{
    ...
    public async Task GetDataAsyncWithHeadersSendsProvidedHeaders()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-headers");
    ...
    public async Task GetDataAsyncWithNullHeadersSendsNoCustomHeaders()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-null-headers");
    ...
    public async Task GetDataAsyncWithQueryParametersSendsProvidedQueryParameters()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-query");
    ...
    public async Task GetDataAsyncWithNullQueryParametersBehavesAsNoQueryParameters()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-null-query");
    ...
    public async Task GetDataAsyncWithQueryParametersWhenValueIsNullEncodesAsEmptyValue()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-null-value");
    ...
    public async Task GetDataAsyncWithQueryParametersUrlEncodesKeyAndValue()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-encoded-query");
    ...
    [Fact]
    public async Task GetDataAsyncWithHeadersWhenTaskCanceledThrowsCommunicationException()
    {
        ...
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-timeout", TimeSpan.FromMilliseconds(50));
        ...
        exception.Message.ShouldContain("Failed to execute http get with TraceId");
        exception.InnerException.ShouldBeOfType<TaskCanceledException>();
    }

    [Fact]
    public async Task GetDataAsyncWithHeadersWhenUnexpectedExceptionThrowsCommunicationException()
    {
        var stoppedServerUri = _serverUri;
        _wireMockServer.Stop();

        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-server-down");
    ...
    {
        var fetcher = CreateFetcherWithDefaultHeadersUsingHttpClient("wiremock-log-query-in-uri");
    ...
    private static LogHttpDataFetcher CreateFetcherWithDefaultHeadersUsingHttpClient(string httpClientName, TimeSpan? timeout = null)
    {
        ...
        return new LogHttpDataFetcher(sdkHttpClient, new Deserializer<response>(), NullLogger<LogHttpDataFetcher>.Instance);
    }
}
