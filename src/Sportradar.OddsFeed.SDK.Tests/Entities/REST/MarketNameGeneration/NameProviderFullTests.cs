...
public class NameProviderFullTests
{
    ...
    public NameProviderFullTests(ITestOutputHelper outputHelper)
    {
    ...
    public async Task WhenMarketNameIsRequestedThenReturnsCorrectName(string marketNameTemplate, string expectedMarketName)
    {
        ...
        _invariantMdProviderMock.Setup(s => s.GetDataAsync(It.IsAny<string>()))
            .ReturnsAsync(MarketDescriptionEndpoint.GetInvariantDto(apiMarketDescription));
    ...
    public async Task GetSingleVariantMarketName()
    {
        ...
        _invariantMdProviderMock.Setup(s => s.GetDataAsync(It.IsAny<string>()))
            .ReturnsAsync(MarketDescriptionEndpoint.GetInvariantDto(apiInvariantMd));
        _singleVariantMdProviderMock.Setup(s =>
                s.GetDataAsync(apiInvariantMd.id.ToString(), TestData.Culture.TwoLetterISOLanguageName, specifiers.First().Value))
            .ReturnsAsync(new MarketDescriptionDto(apiSingleVariantMd));
    ...
    public async Task GetVariantListMarketName()
    {
        ...
        _invariantMdProviderMock.Setup(s => s.GetDataAsync(It.IsAny<string>()))
                                .ReturnsAsync(MarketDescriptionEndpoint.GetInvariantDto(apiInvariantMd));
        _variantMdProviderMock.Setup(s =>
                                         s.GetDataAsync(It.IsAny<string>()))
                              .ReturnsAsync(MarketDescriptionEndpoint.GetVariantDto(apiVariantMd));
    ...
    public async Task GetSingleVariantMarketNameWhenNotFoundThenThrows()
    {
        ...
        _singleVariantMdProviderMock.Setup(s =>
                s.GetDataAsync(apiInvariantMd.id.ToString(), TestData.Culture.TwoLetterISOLanguageName, specifiers.First().Value))
            .ReturnsAsync((MarketDescriptionDto)null);
