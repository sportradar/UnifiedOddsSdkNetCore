...
public class RollbackBetCancelHeadersTests
{
    private readonly ITestOutputHelper _outputHelper;

    public RollbackBetCancelHeadersTests(ITestOutputHelper outputHelper)
    {
        _outputHelper = outputHelper;
    }

    [Fact]
    public async Task RollbackBetCancelMessageContainsAmqpHeaders()
    {
        ...
        var rollbackBetCancel = new rollback_bet_cancel
        {
            product = 1,
        ...
        IRollbackBetCancel<ISportEvent> receivedRollback = null;
        session.OnRollbackBetCancel += (_, e) => receivedRollback = e.GetBetCancelRollback();
        ...
        stubRabbitChannel.SendMessage(rollbackBetCancel, amqpHeaders);
