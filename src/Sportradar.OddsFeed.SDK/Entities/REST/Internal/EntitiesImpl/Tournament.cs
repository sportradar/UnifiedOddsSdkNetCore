...
namespace Sportradar.OddsFeed.SDK.Entities.Rest.Internal.EntitiesImpl
{
    ...
    internal class Tournament : SportEvent, ITournament, IPreloadableEntity
    {
        /// <summary>
        ...
        public async Task<ISportSummary> GetSportAsync()
        {
            ...
            if (sportId == null)
            {
                ExecutionLogPrivate.LogDebug("Missing data. No sportId for tournament cache item with id={SportEventId}", Id);
                return null;
            }
        ...
        public async Task<ICategorySummary> GetCategoryAsync()
        {
            ...
            if (categoryId == null)
            {
                ExecutionLogPrivate.LogDebug("Missing data. No categoryId for tournament cache item with id={SportEventId}", Id);
                return null;
            }
        ...
        public async Task<ICurrentSeasonInfo> GetCurrentSeasonAsync()
        {
            ...
            var currentSeasonInfoCacheItem = ExceptionStrategy == ExceptionHandlingStrategy.Throw
                                                 ...
                                                 : await new Func<IEnumerable<CultureInfo>, Task<CurrentSeasonInfoCacheItem>>(tournamentInfoCacheItem.GetCurrentSeasonInfoAsync)
        ...
        {
            return $"Error occurred while attempting to fetch a summary for a tournament with Id={Id} from the API";
        }
    }
}
