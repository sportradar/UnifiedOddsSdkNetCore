...
namespace Sportradar.OddsFeed.SDK.Entities.Internal
{
    internal interface IMarketFactory
    {
        ...
        IMarketRollbackSettlement GetMarketForRollbackSettlement(ISportEvent sportEvent, market market, int producerId, Urn sportId, IReadOnlyCollection<CultureInfo> cultures);
