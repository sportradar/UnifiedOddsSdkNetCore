...
namespace Sportradar.OddsFeed.SDK.Api.Internal.ApiAccess
{
    ...
    internal class LogHttpDataFetcherFastFailing : LogHttpDataFetcher, ILogHttpDataFetcherFastFailing
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogHttpDataFetcherRecovery"/> class.
        /// </summary>
        /// <param name="sdkHttpClient">A <see cref="ISdkHttpClientFastFailing"/> used to invoke HTTP requests</param>
        ...
        public LogHttpDataFetcherFastFailing(ISdkHttpClientFastFailing sdkHttpClient,
