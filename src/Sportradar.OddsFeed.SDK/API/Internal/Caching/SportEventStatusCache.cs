...
namespace Sportradar.OddsFeed.SDK.Api.Internal.Caching
{
    ...
    internal class SportEventStatusCache : SdkCache, ISportEventStatusCache
    {
        ...
        /// <summary>
        ///     A <see cref="ISingleTypeMapperFactory{restSportEventStatus,SportEventStatusDto}" /> used to created
        ...
        /// </summary>
        /// <param name="sportEventStatusCache">A <see cref="ICacheStore{T}" /> used to cache
        ///     <see cref="SportEventStatusCacheItem" /> instances</param>
        /// <param name="mapperFactory">A <see cref="ISingleTypeMapperFactory{TIn,TOut}" /> used to created
        ///     <see cref="ISingleTypeMapper{SportEventStatusDto}" /> instances</param>
        /// <param name="sportEventCache">A <see cref="ISportEventCache" /> used to cache <see cref="ISportEvent" /></param>
        /// <param name="cacheManager">A <see cref="ICacheManager" /> used to interact among caches</param>
        /// <param name="ignoreEventsTimelineCache">A <see cref="ICacheStore{T}" /> used to cache event ids for which the SES from
        ...
        /// <summary>
        ///     Gets the cached <see cref="SportEventStatusCacheItem" /> instance associated with the sport event specified by the
        ...
        ///     <see cref="SportEventStatusCacheItem" /> instance indicating a 'not started' event is returned.
        /// </summary>
        ...
        public override void SetDtoTypes()
        {
            RegisteredDtoTypes = new List<DtoType>
                                 {
                                     DtoType.Fixture, DtoType.MatchSummary, DtoType.MatchTimeline, DtoType.RaceSummary,
                                     DtoType.SportEventStatus, DtoType.SportEventSummary, DtoType.SportEventSummaryList
                                 };
        }
