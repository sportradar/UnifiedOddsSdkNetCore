...
namespace Sportradar.OddsFeed.SDK.Api.Internal.Caching
{
    ...
    {
        public static GroupCacheItem FindExistingGroup(List<GroupCacheItem> ciGroups, GroupDto dtoGroup)
        {
            // find by id
        ...
        public static GroupDto FindExistingGroup(List<GroupDto> dtoGroups, GroupCacheItem ciGroup)
        {
            // find by id
