...
namespace Sportradar.OddsFeed.SDK.Api.Internal.Recovery
{
    ...
    internal class FeedRecoveryManager : IFeedRecoveryManager
    {
        ...
        /// <summary>
        /// A <see cref="ISdkTimer"/> used to track timeouts between alive messages
        /// </summary>
        private readonly ISdkTimer _inactivityTimer;
        ...
        ///// <param name="config">A <see cref="IUofConfiguration"/> used on feed</param>
        ///// <param name="timer">A <see cref="ISdkTimer"/> used for invocation of period tasks</param>
        ...
        private void Open(IReadOnlyCollection<IProducerRecoveryManager> trackers)
        {
            ...
            if (_sessionMessageManagers.IsNullOrEmpty())
            {
                throw new InvalidOperationException("Missing session message manager");
            }
