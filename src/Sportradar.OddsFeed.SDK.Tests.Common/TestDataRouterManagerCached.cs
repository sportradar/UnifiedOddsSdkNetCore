...
internal class TestDataRouterManagerCached : IDataRouterManager
{
    ...
    public async Task GetSportEventSummaryAsync(Urn id, CultureInfo culture, ISportEventCacheItem requester)
    {
        ...
        if (string.IsNullOrEmpty(filePath) &&
            id?.TypeGroup != ResourceTypeGroup.BasicTournament &&
    ...
    public Task GetCompetitorAsync(Urn id, CultureInfo culture, ISportEventCacheItem requester)
    {
    ...
    public Task<PeriodSummaryDto> GetPeriodSummaryAsync(Urn id, CultureInfo culture, ISportEventCacheItem requester, ICollection<Urn> competitorIds = null, ICollection<int> periods = null)
    {
        throw new NotImplementedException();
    }

    private async Task LogSaveDtoAsync(Urn id, object item, CultureInfo culture, DtoType dtoType, ISportEventCacheItem requester)
    {
        if (item != null)
        {
