...
@xsd.exe /c /l:C# /n:Sportradar.OddsFeed.SDK.Messages.Internal.REST bsa/v1/endpoints/unified/competitor_profile.xsd bsa/v1/endpoints/unified/fixture_changes.xsd bsa/v1/endpoints/unified/fixtures_fixture.xsd bsa/v1/endpoints/unified/match_summary.xsd bsa/v1/endpoints/unified/match_timeline.xsd bsa/v1/endpoints/unified/player_profile.xsd bsa/v1/endpoints/unified/result.xsd bsa/v1/endpoints/unified/results.xsd bsa/v1/endpoints/unified/schedule.xsd bsa/v1/endpoints/unified/sport_categories.xsd bsa/v1/endpoints/unified/sport_tournaments.xsd bsa/v1/endpoints/unified/sports.xsd bsa/v1/endpoints/unified/tournament_info.xsd bsa/v1/endpoints/unified/tournament_schedule.xsd bsa/v1/endpoints/unified/tournaments.xsd bsa/v1/endpoints/unified/venue_summary.xsd bsa/v1/endpoints/unified/tournament_seasons.xsd bsa/v1/endpoints/unified/race_summary.xsd bsa/v1/endpoints/unified/lottery_schedule.xsd bsa/v1/endpoints/unified/lotteries.xsd bsa/v1/endpoints/unified/draw_fixtures.xsd bsa/v1/endpoints/unified/simpleteam_profile.xsd bsa/v1/endpoints/unified/draw_summary.xsd custombet/v1/endpoints/AvailableSelections.xsd custombet/v1/endpoints/Calculation.xsd custombet/v1/endpoints/ErrorResponse.xsd custombet/v1/endpoints/Selections.xsd
